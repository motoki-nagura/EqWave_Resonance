...
for year_name in $years; do
  ...
  cdo sellonlatbox,${lons},${lone},${lats},${late} $in_u ./u_0p1S-0p1N${ext_out}

  cdo sellonlatbox,${lons},${lone},${lat0},${lat0} $in_u ./u_eq${ext_out}
  cdo sellonlatbox,${lons},${lone},${lat0},${lat0} $in_v ./v_eq${ext_out}

  python calc_u_gradient.py ${ext_out}
