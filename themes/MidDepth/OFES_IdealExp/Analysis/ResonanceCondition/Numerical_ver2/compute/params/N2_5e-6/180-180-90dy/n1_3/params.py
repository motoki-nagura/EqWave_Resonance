...
def get_params() -> Params:
    ...
    return Params(
        ...
        n1_values = np.array([3]),          #  Meridional mode number for wave 1
        ...
        #k1_values = 2.*π *np.linspace(0.1, 1./(750.*1e3), 51),
                                            #  Zonal wavelength for wave 1 [rad m^-1]
        m1_guess = 1.5e-3,                  #  Initial guess of zonal wavenumber for wave 1 [rad m^-1]
